...
, nursingchartoffset
-- lowest
, avg(case when heartrate >= 0 and heartrate <= 400 then heartrate else null end) as heartrate
, avg(case when RespiratoryRate >= 0 and RespiratoryRate <= 300 then RespiratoryRate else null end) as RespiratoryRate
, avg(case when o2saturation >= 0 and o2saturation <= 100 then o2saturation else null end) as o2saturation
, avg(case when nibp_systolic >= 1 and nibp_systolic <= 300 then nibp_systolic else null end) as nibp_systolic
, avg(case when nibp_diastolic >= 1 and nibp_diastolic <= 200 then nibp_diastolic else null end) as nibp_diastolic
, avg(case when nibp_mean >= 1 and nibp_mean <= 334 then nibp_mean else null end) as nibp_mean
...
, avg(case when ibp_mean >= 1 and ibp_mean <= 334 then ibp_mean else null end) as ibp_mean
, avg(case when gcs > 2 and gcs < 16 then gcs else null end) as gcs
, avg(case when map >= 1 and map <= 334 then map else null end) as map
from nc
